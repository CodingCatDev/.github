# Contributing to CodingCatDev

We would love for you to contribute to CodingCatDev and help make it even better than it is today!
As a contributor, here are the guidelines we would like you to follow:

 - [How to open a Pull Request (PR)](#pr)

# <a name="pr"></a> How to open a Pull Request (PR)

A pull request (PR) enables you to send changes from your fork on GitHub to CodingCatDev.org's main repository. Once you are done making changes to the code, you can follow these guidelines to open a PR.
...
You can select a scope from [this list of labels](https://github.com/CodingCatDev/codingcat.dev/labels?q=scope).
...
2. By default, all pull requests should be against the main repo, `dev` branch.

   Make sure that your Base Fork is set to CodingCatDev/<repo> when raising a Pull Request.
...
3. Submit the pull request from your branch to CodingCatDev's `main` branch.
...
And as always, feel free to ask questions on the [GitHub Discussions](https://github.com/CodingCatDev/codingcat.dev/discussions/409) or [Discord](https://discord.com/invite/vM2bagU).
